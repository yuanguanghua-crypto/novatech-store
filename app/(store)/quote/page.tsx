      ...
      <div className="container py-8">
        ...
        <section className="mb-12 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-gray-900">{t.quote_when_need}</h2>
            </div>
          ...
          <div className="bg-white rounded-xl border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-gray-900">{t.quote_process}</h2>
            </div>
          ...
          <div className="bg-white rounded-xl border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-gray-900">{t.quote_delivery}</h2>
            </div>
        ...
        <section className="mt-12 bg-white rounded-xl border p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">{t.quote_faq_title}</h2>
            <button
